...
const form = useForm({
    title: props.systemNotice.title,
    content: props.systemNotice.content,
    is_active: props.systemNotice.is_active,
    is_dismissible: props.systemNotice.is_dismissible,
    type: props.systemNotice.type,
    visible_from: formatDateForInput(props.systemNotice.visible_from),
    expires_at: formatDateForInput(props.systemNotice.expires_at),
})
...
const submit = () => {
    form.put(route('admin.system-notice.update', props.systemNotice.id), {
        preserveScroll: true,
    })
}
</script>
...
<template>
    ...
    <Head title="Edit System Notice" />
    <main class="max-w-7xl mx-auto" aria-labelledby="edit-system-notice">
        <div class="container-border">
            <PageHeader title="Edit System Notice" description="Edit a system-wide notice for all users." :breadcrumbs="[
            ...
            <div class="p-6 dark:bg-gray-900">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                    <form id="edit-notice-form" @submit.prevent="submit" class="max-w-2xl space-y-8">
                        <div class="space-y-6">
            ...
            <div class="px-6 py-4 bg-gray-50 dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex justify-end">
                <button type="submit" form="edit-notice-form" class="btn btn-sm btn-primary" :disabled="form.processing"

                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            ...
                            <p class="text-sm text-amber-700 dark:text-amber-400 font-medium flex items-center gap-2">
                                ...
                                If you notice any suspicious activity, immediately sign out of all other browser
                                sessions
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800 p-4 sm:p-6">
                            ...
                            <div class="p-3 sm:p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-700">
                                <h4 class="text-sm sm:text-base font-medium text-gray-900 dark:text-gray-100 mb-2">Sign Out All Other Sessions</h4>
                                <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-3 sm:mb-4 leading-relaxed">
                                    This will terminate access from any other devices where you're currently logged in. Your current session will remain active.
                                </p>
    ...
    <Modal :show="logoutAllModal" @close="logoutAllModal = false" size="sm">
        ...
        <template #footer>
            <div class="flex justify-end gap-8">
                ...
                <button @click="logoutAllSessions" type="button" class="btn btn-sm btn-danger"
                    :disabled="passwordForm.processing">

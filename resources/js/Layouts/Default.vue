    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900" role="document">
        ...
        <div class="flex flex-col min-h-screen">
            ...
            >
                <!-- System Notices -->
                <SystemNotice
                    :notices="page.props.systemNotices"
                    @height-change="handleNoticeHeightChange"
                />

                <!-- Navigation -->
                <nav
                    class="flex h-17 items-center px-4 gap-4 shadow-sm"
                    role="navigation"
                ...
                >
                    ...
                    <section
                        ...
                        aria-label="Laravel Admin logo and menu controls"
                    >
                        <Link
                            href="/"
                    ...
                    <!-- Desktop Search -->
                    <section
                        class="hidden lg:block flex-shrink-0 ml-4"
